...
/* harmony import */ var _push_service_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./push-service.service */ "./src/app/push-service.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["Platform"],
            ...
            _push_service_service__WEBPACK_IMPORTED_MODULE_4__["PushServiceService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _push_service_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./push-service.service */ "./src/app/push-service.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                _push_service_service__WEBPACK_IMPORTED_MODULE_13__["PushServiceService"],
...
/* harmony import */ var _ionic_native_push__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic-native/push */ "./node_modules/@ionic-native/push/index.js");
/* harmony import */ var _ionic_native_device__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ionic-native/device */ "./node_modules/@ionic-native/device/index.js");
...
var PushServiceService = /** @class */ (function () {
    ...
    PushServiceService.prototype._getdevice = function () {
        this.uuid = _ionic_native_device__WEBPACK_IMPORTED_MODULE_3__["Device"].uuid;
        // console.log('Device UUID is: ' + this.device.uuid);
        // this._devicepath = this.afdb.list(`devices/${this.uuid}`);
    };
    PushServiceService.prototype.pushInt = function () {
        var _this = this;
        // to check if we have permission
        _ionic_native_push__WEBPACK_IMPORTED_MODULE_2__["Push"].hasPermission()
            .then(function (res) {
            if (res.isEnabled) {
        ...
        var options = {
            android: {
                senderID: _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].firebase.messagingSenderId,
                clearBadge: true,
        ...
        var pushObject = _ionic_native_push__WEBPACK_IMPORTED_MODULE_2__["Push"].init(options);
        ...
        pushObject.on('registration')
            ...
            _this.savePushToken(registration.registrationId);
        });
        pushObject.on('error').subscribe(function (error) { return console.error('Error with Push plugin', error); });
    };
    PushServiceService.prototype.savePushToken = function (token) {
        var payload = {
            token: token
        };
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyCD2wyeJPst-rYoLBubnIf91LCVku-sR5A",
        authDomain: "aiza-9788c.firebaseapp.com",
        databaseURL: "https://aiza-9788c.firebaseio.com",
        projectId: "aiza-9788c",
        storageBucket: "aiza-9788c.appspot.com",
        messagingSenderId: "979818646327"
    }
};
/*
...
module.exports = __webpack_require__(/*! /Users/tomasmalix/Documents/My_Workspace/Ionic_Workspace/aiza/src/main.ts */"./src/main.ts");
